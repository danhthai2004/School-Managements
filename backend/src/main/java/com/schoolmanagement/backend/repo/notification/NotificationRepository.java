...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    List<Notification> findByTargetSchoolOrderByCreatedAtDesc(com.schoolmanagement.backend.domain.entity.admin.School school);
    ...
    List<Notification> findVisibleNotifications(
        ...
        @org.springframework.data.repository.query.Param("role") com.schoolmanagement.backend.domain.auth.Role role
    );
