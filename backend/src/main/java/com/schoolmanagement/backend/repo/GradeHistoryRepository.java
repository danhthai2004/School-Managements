...
import com.schoolmanagement.backend.domain.entity.GradeHistory;
...
public interface GradeHistoryRepository extends JpaRepository<GradeHistory, UUID> {
    ...
    void deleteAllByStudent(
            @org.springframework.data.repository.query.Param("student") com.schoolmanagement.backend.domain.entity.Student student);
}
