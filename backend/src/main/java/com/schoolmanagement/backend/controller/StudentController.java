...
import com.schoolmanagement.backend.service.StudentPortalService;
...
public class StudentController {
    ...
    public ResponseEntity<NotificationCountResponse> getNotificationCount(@AuthenticationPrincipal UserPrincipal principal) {
        Student student = getStudentByUserId(principal.getId());
