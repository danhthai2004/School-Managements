    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/school/semesters/**", "/api/school/academic-years/**")
                        .hasAnyRole("SCHOOL_ADMIN", "TEACHER", "STUDENT", "GUARDIAN")
                        .requestMatchers("/api/school/**", "/api/school-admin/**").hasRole("SCHOOL_ADMIN")
                        ...
                        .hasAnyRole("SYSTEM_ADMIN", "SCHOOL_ADMIN", "TEACHER", "STUDENT", "GUARDIAN")
                        // Risk Analytics APIs
