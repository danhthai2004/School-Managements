...
import com.schoolmanagement.backend.dto.teacher.AttendanceDto;
import com.schoolmanagement.backend.dto.teacher.AttendanceReportSummaryDto;
import com.schoolmanagement.backend.dto.teacher.DailyAttendanceSummaryDto;
import com.schoolmanagement.backend.dto.teacher.SaveAttendanceRequest;
import com.schoolmanagement.backend.dto.teacher.StudentAttendanceDetailDto;
...
public class AttendanceService {
        ...
        public List<AttendanceDto> getAttendanceForSlot(String email, LocalDate date, int slotIndex) {
                ...
                // Query TimetableDetail for this teacher, slot, and verify day of week
        ...
        public void saveAttendance(String email, SaveAttendanceRequest request) {
                ...
                // Check if slot has started (teachers can only mark attendance when period
                // begins)
        ...
        public DailyAttendanceSummaryDto getDailyAttendanceSummary(String email, LocalDate date) {
                ...
                // Note: Reusing logic from TeacherPortalService could be better, but duplicated
                // for now to keep independent service clean
        ...
        public AttendanceReportSummaryDto getAttendanceReport(String email, LocalDate startDate, LocalDate endDate,
                ...
                // 4. Count unique school days (days that have at least one attendance record)
         ...
         * Optionally filter by status (e.g. only show ABSENT_UNEXCUSED records)
         */
                ...
                records = records.stream()
                                .sorted((a, b) -> {
                                        ...
                                        return dateComp != 0 ? dateComp
                                                        : Integer.compare(a.getSlotIndex(), b.getSlotIndex());
                                })
                                .toList();
        ...
        // Simplification: We look for ANY entry in TimetableDetail matching teacher,
        // day of week, slot.
        // In a real complex system, we might need to check Effective Date range of
        // Timetable.
        // Assuming active official timetable logic is handled by caller or simplified
        // here.
        private TimetableDetail findTimetableDetail(Teacher teacher, LocalDate date, int slotIndex) {
                // Find official timetable for school
                // Find official timetable for school
