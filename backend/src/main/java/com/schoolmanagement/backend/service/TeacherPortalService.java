...
public class TeacherPortalService {
        ...
        private final com.schoolmanagement.backend.repo.ExamInvigilatorRepository examInvigilatorRepository;

        private static final String[] CONDUCT_GRADES = { "Xuất sắc", "Tốt", "Khá", "Trung bình", "Yếu" };

        public List<com.schoolmanagement.backend.dto.student.ExamScheduleDto> getExamSchedule(String email,
                ...
                List<com.schoolmanagement.backend.domain.entity.ExamInvigilator> invigilations;
                ...
                return invigilations.stream()
                                .map(invigilation -> {
                                        com.schoolmanagement.backend.domain.entity.ExamSchedule exam = invigilation
                                                        .getExamRoom().getExamSchedule();
                                        com.schoolmanagement.backend.domain.entity.ExamRoom room = invigilation
                                                        .getExamRoom();

                                        String status;
                                        if (exam.getStatus() == com.schoolmanagement.backend.domain.ExamStatus.COMPLETED
                                                        || exam.getStatus() == com.schoolmanagement.backend.domain.ExamStatus.CANCELLED) {
                                        ...
                                        com.schoolmanagement.backend.dto.student.ExamScheduleDto dto = com.schoolmanagement.backend.dto.student.ExamScheduleDto
                                                        .builder()
        ...
        private List<TeacherProfileDto.AssignedClassDto> getAssignedClasses(User user) {
                ...
                List<com.schoolmanagement.backend.domain.entity.TeacherAssignment> assignments = teacherAssignmentRepository
