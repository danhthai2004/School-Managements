...
import { Bell, X, Clock, ArrowLeft, CheckCheck, ChevronRight } from "lucide-react";
                                    ...
                                    >
                                        <div className="flex gap-3">
                                            <div className="relative flex-shrink-0">
                                                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${!notification.isRead ? 'bg-blue-100' : 'bg-gray-100'
                                                    }`}>
                                                    <Bell className={`w-5 h-5 ${!notification.isRead ? 'text-blue-600' : 'text-gray-400'
                                                        }`} />
                                                </div>
                                                {!notification.isRead && (
                        ...
                        <div className="px-4 py-3 border-t border-gray-100 bg-white">
                            <button
                                onClick={() => {
                                    ...
                                    if (role === "SYSTEM_ADMIN") navigate("/system/notifications");
                                    else if (role === "SCHOOL_ADMIN") navigate("/school-admin/notifications");
                                    else if (role === "TEACHER") navigate("/teacher/notifications");
                                    else if (role === "GUARDIAN") navigate("/guardian/notification");
                                    else if (role === "STUDENT") navigate("/student/notification");
                                }}
