...
export const NoAcademicYearState: React.FC<{ onAction?: () => void }> = ({ onAction }) => (
    <EmptyState
        ...
        title="Chưa có năm học nào được tạo"
        description="Vui lòng thêm năm học để bắt đầu quản lý dữ liệu."
        action={onAction ? { label: "Đi đến Thiết lập năm học", onClick: onAction } : undefined}
    />
);
